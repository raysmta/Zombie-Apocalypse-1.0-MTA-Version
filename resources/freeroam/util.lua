...
function putCameraAt(x, y, z)
	toggleCameraFixedMode(true)
	setTimer(setCameraPosition, 100, 1, x, y, z)
end
...
function setCameraPlayerMode()
	...
	setCameraPosition(x - 4*math.cos(math.rad(r + 90)), y - 4*math.sin(math.rad(r + 90)), z + 1)
	setTimer(setCameraLookAt, 50, 1, x, y, z + 1)
	setTimer(toggleCameraFixedMode, 100, 1, false)
end
