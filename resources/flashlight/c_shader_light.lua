...
function createWorldLight(thisPed)
	...
	flashLiTable.shLight[thisPed] = exports.dynamic_lighting:createSpotLight(0,0,3,gLightColor[1],gLightColor[2],gLightColor[3],gLightColor[4],0,0,0,flase,gLightFalloff,gLightTheta,gLightPhi,20,gWorldSelfShadow)
end
