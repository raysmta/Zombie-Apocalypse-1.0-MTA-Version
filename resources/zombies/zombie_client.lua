...
--SKIN REPLACEMENTS
	local skin = engineLoadTXD ( "skins/10.txd" ) --bleedin eyes 31 by Slothman
	engineImportTXD ( skin, 10 )
	local skin = engineLoadTXD ( "skins/11.txd" ) -- slashed 12 by Wall-E
	engineImportTXD ( skin, 11 )	
	local skin = engineLoadTXD ( "skins/12.txd" ) --young and blue by Slothman
	engineImportTXD ( skin, 12 )
	local skin = engineLoadTXD ( "skins/13.txd" ) -- slit r* employee
	engineImportTXD ( skin, 13 )
	local skin = engineLoadTXD ( "skins/14.txd" ) -- shredded preist by Deixell
